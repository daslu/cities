...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_51098 = 0;while(true){
var m_51099 = cljs.core.async.impl.dispatch.tasks.pop();if((m_51099 == null))
{} else
{m_51099.call(null);
if((count_51098 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__51100 = (count_51098 + 1);
count_51098 = G__51100;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__26243__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__26243__auto__)
