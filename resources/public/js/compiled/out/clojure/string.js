...
{{
var G__46930 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46930;
continue;
}
} else
...
{var pred__46934 = cljs.core._EQ_;var expr__46935 = limit;if(cljs.core.truth_(pred__46934.call(null,1,expr__46935)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46934.call(null,2,expr__46935)))
...
var G__46937 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46938 = (limit__$1 - 1);
var G__46939 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46937;
limit__$1 = G__46938;
parts = G__46939;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___46941 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___46941))
{var replacement_46942 = temp__4124__auto___46941;buffer.append([cljs.core.str(replacement_46942)].join(''));
} else
{buffer.append(ch);
}
{
var G__46943 = (index + 1);
index = G__46943;
continue;
}
}
