...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__26255__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__26255__auto__))
{return or__26255__auto__;
} else
{var or__26255__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__26255__auto____$1))
{return or__26255__auto____$1;
} else
{var or__26255__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__26255__auto____$2))
{return or__26255__auto____$2;
} else
{var or__26255__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__26255__auto____$3))
...
var n__27103__auto__ = a.length;var i = 0;while(true){
if((i < n__27103__auto__))
{var C_47093 = (a[i]);if(cljs.core.truth_(C_47093.cljsIsDirty))
{C_47093.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__26822__auto__,writer__26823__auto__,opt__26824__auto__){return cljs.core._write.call(null,writer__26823__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__26243__auto__ = !((C == null));if(and__26243__auto__)
{var and__26243__auto____$1 = (C["props"]);if(cljs.core.truth_(and__26243__auto____$1))
...
{C.cljsRatom = reagent.ratom.make_reaction.call(null,run,new cljs.core.Keyword(null,"auto-run","auto-run",2451476703),((function (res,derefed,rat){
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_47095 = C.cljsRatom;if(!((ratom_47095 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_47095);
} else
{}
