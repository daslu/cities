...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_47081 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"f","f",-1640531425,null))))].join('')))})());var p = reagent.impl.util.js_props.call(null,C);var res = ((((C["componentFunction"]) == null))?f.call(null,C):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count.call(null,argv);var G__47082 = n;if(cljs.core._EQ_.call(null,5,G__47082))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3),cljs.core.nth.call(null,argv,4));
} else
{if(cljs.core._EQ_.call(null,4,G__47082))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3));
} else
{if(cljs.core._EQ_.call(null,3,G__47082))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2));
} else
{if(cljs.core._EQ_.call(null,2,G__47082))
{return f.call(null,cljs.core.nth.call(null,argv,1));
} else
{if(cljs.core._EQ_.call(null,1,G__47082))
{return f.call(null);
} else
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_47081;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__47084 = key;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",4147620643),G__47084))
{return ((function (G__47084){
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",4103164189),G__47084))
{return ((function (G__47084){
return (function (oldprops){var C = this;var old_argv = (oldprops[reagent.impl.util.cljs_argv]);return f.call(null,C,old_argv);
});
;})(G__47084))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUpdate","componentWillUpdate",2086388618),G__47084))
{return ((function (G__47084){
return (function (nextprops){var C = this;var next_argv = (nextprops[reagent.impl.util.cljs_argv]);return f.call(null,C,next_argv);
});
;})(G__47084))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",3193956709),G__47084))
{return ((function (G__47084){
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillReceiveProps","componentWillReceiveProps",2122862542),G__47084))
{return ((function (G__47084){
return (function (props){var C = this;return f.call(null,C,(props[reagent.impl.util.cljs_argv]));
});
;})(G__47084))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getInitialState","getInitialState",2219830677),G__47084))
{return ((function (G__47084){
return (function (){var C = this;return reagent.impl.component.set_state.call(null,C,f.call(null,C));
});
;})(G__47084))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getDefaultProps","getDefaultProps",1976256919),G__47084))
{if(false)
{return null;
} else
...
{return (function() { 
var G__47085__delegate = function (args){var C = this;return cljs.core.apply.call(null,f,C,args);
};
...
G__47085.cljs$lang$applyTo = (function (arglist__47086){
var args = cljs.core.seq(arglist__47086);
...
{var G__47088 = f;(G__47088["__reactDontBind"] = true);
return G__47088;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper.call(null,key,f);if(cljs.core.truth_((function (){var and__26243__auto__ = wrap;if(cljs.core.truth_(and__26243__auto__))
{return f;
} else
...
{}
var or__26255__auto__ = wrap;if(cljs.core.truth_(or__26255__auto__))
...
reagent.impl.component.wrap_funs = (function wrap_funs(fun_map){var render_fun = (function (){var or__26255__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",1139645287).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__26255__auto__))
{return or__26255__auto__;
} else
{return new cljs.core.Keyword(null,"render","render",4374279432).cljs$core$IFn$_invoke$arity$1(fun_map);
}
})();var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"render-fun","render-fun",-447610239,null))))].join('')))})());var name = (function (){var or__26255__auto__ = new cljs.core.Keyword(null,"displayName","displayName",2728053215).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__26255__auto__))
{return or__26255__auto__;
} else
{var or__26255__auto____$1 = render_fun.displayName;if(cljs.core.truth_(or__26255__auto____$1))
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__47090 = o;(G__47090[cljs.core.name.call(null,k)] = v);
return G__47090;
}),{},m);
});
...
return (function() { 
var G__47091__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
...
G__47091.cljs$lang$applyTo = (function (arglist__47092){
var args = cljs.core.seq(arglist__47092);
